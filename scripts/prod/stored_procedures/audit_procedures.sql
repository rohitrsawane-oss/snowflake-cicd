...
CREATE OR REPLACE PROCEDURE "LOAD_FILES_FROM_ARCHIVE_TO_EPIC"("BRONZE_TABLE_NAME" VARCHAR)
RETURNS VARCHAR
LANGUAGE SQL
EXECUTE AS OWNER
AS '
...
CREATE OR REPLACE PROCEDURE "LOAD_FILES_FROM_EPIC_STAGE"("BRONZE_TABLE_NAME" VARCHAR)
RETURNS VARCHAR
LANGUAGE SQL
EXECUTE AS CALLER
AS '
