...
GRANT USAGE,MONITOR ON SCHEMA TRUSTCAB_PROD.SCH_TRUSTCAB_AUDIT TO DATABASE ROLE AR_PROD_TRANS_RW;
GRANT USAGE,MONITOR ON SCHEMA TRUSTCAB_PROD.SCH_TRUSTCAB_AUDIT TO DATABASE ROLE AR_PROD_TRANS_RO;

GRANT CREATE TABLE, CREATE VIEW, CREATE MATERIALIZED VIEW, CREATE MASKING POLICY, 
      CREATE ROW ACCESS POLICY, CREATE SEQUENCE, CREATE FUNCTION, CREATE PROCEDURE,
      CREATE FILE FORMAT, CREATE STAGE, CREATE TASK 
      ON SCHEMA TRUSTCAB_PROD.SCH_TRUSTCAB_AUDIT TO DATABASE ROLE AR_PROD_TRANS_RW;
	  
USE ROLE SECURITYADMIN;
USE DATABASE TRUSTCAB_PROD;

-- AR_PROD_TRANS_RW - Full Access to Bronze Layer Objects
GRANT ALL ON ALL TABLES IN SCHEMA TRUSTCAB_PROD.SCH_TRUSTCAB_AUDIT TO DATABASE ROLE AR_PROD_TRANS_RW;
GRANT ALL ON ALL VIEWS IN SCHEMA TRUSTCAB_PROD.SCH_TRUSTCAB_AUDIT TO DATABASE ROLE AR_PROD_TRANS_RW;
GRANT ALL ON ALL PROCEDURES IN SCHEMA TRUSTCAB_PROD.SCH_TRUSTCAB_AUDIT TO DATABASE ROLE AR_PROD_TRANS_RW;
GRANT ALL ON ALL FUNCTIONS IN SCHEMA TRUSTCAB_PROD.SCH_TRUSTCAB_AUDIT TO DATABASE ROLE AR_PROD_TRANS_RW;
GRANT ALL ON ALL TASKS IN SCHEMA TRUSTCAB_PROD.SCH_TRUSTCAB_AUDIT TO DATABASE ROLE AR_PROD_TRANS_RW;
GRANT ALL ON ALL MATERIALIZED VIEWS IN SCHEMA TRUSTCAB_PROD.SCH_TRUSTCAB_AUDIT TO DATABASE ROLE AR_PROD_TRANS_RW;
GRANT ALL ON ALL SEQUENCES IN SCHEMA TRUSTCAB_PROD.SCH_TRUSTCAB_AUDIT TO DATABASE ROLE AR_PROD_TRANS_RW;
GRANT ALL ON ALL STAGES IN SCHEMA TRUSTCAB_PROD.SCH_TRUSTCAB_AUDIT TO DATABASE ROLE AR_PROD_TRANS_RW;
GRANT ALL ON ALL FILE FORMATS IN SCHEMA TRUSTCAB_PROD.SCH_TRUSTCAB_AUDIT TO DATABASE ROLE AR_PROD_TRANS_RW;	


USE ROLE ACCOUNTADMIN;

-- AR_PROD_TRANS_RW - Future Objects in Bronze Layer
GRANT ALL ON FUTURE TABLES IN SCHEMA TRUSTCAB_PROD.SCH_TRUSTCAB_AUDIT TO DATABASE ROLE AR_PROD_TRANS_RW;
GRANT ALL ON FUTURE VIEWS IN SCHEMA TRUSTCAB_PROD.SCH_TRUSTCAB_AUDIT TO DATABASE ROLE AR_PROD_TRANS_RW;
GRANT ALL ON FUTURE PROCEDURES IN SCHEMA TRUSTCAB_PROD.SCH_TRUSTCAB_AUDIT TO DATABASE ROLE AR_PROD_TRANS_RW;
GRANT ALL ON FUTURE FUNCTIONS IN SCHEMA TRUSTCAB_PROD.SCH_TRUSTCAB_AUDIT TO DATABASE ROLE AR_PROD_TRANS_RW;
GRANT ALL ON FUTURE TASKS IN SCHEMA TRUSTCAB_PROD.SCH_TRUSTCAB_AUDIT TO DATABASE ROLE AR_PROD_TRANS_RW;
GRANT ALL ON FUTURE MATERIALIZED VIEWS IN SCHEMA TRUSTCAB_PROD.SCH_TRUSTCAB_AUDIT TO DATABASE ROLE AR_PROD_TRANS_RW;
GRANT ALL ON FUTURE SEQUENCES IN SCHEMA TRUSTCAB_PROD.SCH_TRUSTCAB_AUDIT TO DATABASE ROLE AR_PROD_TRANS_RW;
GRANT ALL ON FUTURE STAGES IN SCHEMA TRUSTCAB_PROD.SCH_TRUSTCAB_AUDIT TO DATABASE ROLE AR_PROD_TRANS_RW;
GRANT ALL ON FUTURE FILE FORMATS IN SCHEMA TRUSTCAB_PROD.SCH_TRUSTCAB_AUDIT TO DATABASE ROLE AR_PROD_TRANS_RW;  

GRANT SELECT ON ALL TABLES IN SCHEMA TRUSTCAB_PROD.SCH_TRUSTCAB_AUDIT TO DATABASE ROLE AR_PROD_TRANS_RO;
GRANT SELECT ON ALL VIEWS IN SCHEMA TRUSTCAB_PROD.SCH_TRUSTCAB_AUDIT TO DATABASE ROLE AR_PROD_TRANS_RO;
GRANT SELECT ON ALL MATERIALIZED VIEWS IN SCHEMA TRUSTCAB_PROD.SCH_TRUSTCAB_AUDIT TO DATABASE ROLE AR_PROD_TRANS_RO;
GRANT SELECT ON FUTURE TABLES IN SCHEMA TRUSTCAB_PROD.SCH_TRUSTCAB_AUDIT TO DATABASE ROLE AR_PROD_TRANS_RO;
GRANT SELECT ON FUTURE VIEWS IN SCHEMA TRUSTCAB_PROD.SCH_TRUSTCAB_AUDIT TO DATABASE ROLE AR_PROD_TRANS_RO;
GRANT SELECT ON FUTURE MATERIALIZED VIEWS IN SCHEMA TRUSTCAB_PROD.SCH_TRUSTCAB_AUDIT TO DATABASE ROLE AR_PROD_TRANS_RO;

USE ROLE securityadmin;
GRANT CREATE DYNAMIC TABLE ON SCHEMA TRUSTCAB_PROD.SCH_TRUSTCAB_AUDIT TO DATABASE ROLE AR_PROD_TRANS_RW;
GRANT ALL ON ALL DYNAMIC TABLES IN SCHEMA TRUSTCAB_PROD.SCH_TRUSTCAB_AUDIT TO DATABASE ROLE AR_PROD_TRANS_RW;
GRANT SELECT ON ALL DYNAMIC  TABLES IN SCHEMA TRUSTCAB_PROD.SCH_TRUSTCAB_AUDIT TO DATABASE ROLE AR_PROD_TRANS_RO;


USE ROLE ACCOUNTADMIN;
GRANT SELECT ON FUTURE DYNAMIC TABLES IN SCHEMA TRUSTCAB_PROD.SCH_TRUSTCAB_AUDIT TO DATABASE ROLE AR_PROD_TRANS_RO;
GRANT ALL ON FUTURE DYNAMIC TABLES IN SCHEMA TRUSTCAB_PROD.SCH_TRUSTCAB_AUDIT TO DATABASE ROLE AR_PROD_TRANS_RO;

USE ROLE SECURITYADMIN;
USE DATABASE trustcab_PROD;

-- Grant USAGE, MONITOR on TRUSTCAB_PROD to RW database roles
GRANT USAGE, MONITOR ON SCHEMA TRUSTCAB_PROD.SCH_TRUSTCAB_AUDIT TO DATABASE ROLE TRUSTCAB_PROD.AR_PROD_TRANS_RW;
GRANT USAGE, MONITOR ON SCHEMA TRUSTCAB_PROD.SCH_TRUSTCAB_AUDIT TO DATABASE ROLE TRUSTCAB_PROD.AR_PROD_TRANS_RO;
