...
WAREHOUSE='{WAREHOUSE_NAME}'
AFTER BRONZE_LOAD_PASSENGER_SUMMARY_TASK
AS
...
WAREHOUSE='{WAREHOUSE_NAME}'
AFTER BRONZE_LOAD_DIM_CITY_TASK
AS
...
WAREHOUSE='{WAREHOUSE_NAME}'
AFTER BRONZE_LOAD_FACT_TRIPS_TASK
AS
...
WAREHOUSE='{WAREHOUSE_NAME}'
AFTER BRONZE_LOAD_MONTHLY_TARGET_PASSENGERS_TASK
AS
...
WAREHOUSE='{WAREHOUSE_NAME}'
AFTER BRONZE_LOAD_MONTHLY_TARGET_TRIPS_TASK
AS
