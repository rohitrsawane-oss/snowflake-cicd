...
INSERT INTO {DATABASE_NAME}.SCH_TRUSTCAB_BRONZE.CITY_TARGET_PASSENGER_RATING
SELECT * FROM trustcab_dev.SCH_TRUSTCAB_BRONZE.CITY_TARGET_PASSENGER_RATING;

-- 2. DIM_CITY
INSERT INTO {DATABASE_NAME}.SCH_TRUSTCAB_BRONZE.DIM_CITY
SELECT * FROM trustcab_dev.SCH_TRUSTCAB_BRONZE.DIM_CITY;

-- 3. DIM_DATE
INSERT INTO {DATABASE_NAME}.SCH_TRUSTCAB_BRONZE.DIM_DATE
SELECT * FROM trustcab_dev.SCH_TRUSTCAB_BRONZE.DIM_DATE;

-- 4. DIM_REPEAT_TRIP_DISTRIBUTION
INSERT INTO {DATABASE_NAME}.SCH_TRUSTCAB_BRONZE.DIM_REPEAT_TRIP_DISTRIBUTION
SELECT * FROM trustcab_dev.SCH_TRUSTCAB_BRONZE.DIM_REPEAT_TRIP_DISTRIBUTION;

-- 5. FACT_PASSENGER_SUMMARY
INSERT INTO {DATABASE_NAME}.SCH_TRUSTCAB_BRONZE.FACT_PASSENGER_SUMMARY
SELECT * FROM trustcab_dev.SCH_TRUSTCAB_BRONZE.FACT_PASSENGER_SUMMARY;

-- 6. FACT_TRIPS
INSERT INTO {DATABASE_NAME}.SCH_TRUSTCAB_BRONZE.FACT_TRIPS
SELECT * FROM trustcab_dev.SCH_TRUSTCAB_BRONZE.FACT_TRIPS;

-- 7. MONTHLY_TARGET_NEW_PASSENGERS
INSERT INTO {DATABASE_NAME}.SCH_TRUSTCAB_BRONZE.MONTHLY_TARGET_NEW_PASSENGERS
SELECT * FROM trustcab_dev.SCH_TRUSTCAB_BRONZE.MONTHLY_TARGET_NEW_PASSENGERS;

-- 8. MONTHLY_TARGET_TRIPS
INSERT INTO {DATABASE_NAME}.SCH_TRUSTCAB_BRONZE.MONTHLY_TARGET_TRIPS
SELECT * FROM trustcab_dev.SCH_TRUSTCAB_BRONZE.MONTHLY_TARGET_TRIPS;